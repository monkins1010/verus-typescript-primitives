...
export const DataByteKeyName = "vrsc::data.type.byte";
export const DataByteKey: VDXFKeyInterface = {
...
export const DataInt16KeyName = "vrsc::data.type.int16";
export const DataInt16Key: VDXFKeyInterface = {
...
export const DataUint16KeyName = "vrsc::data.type.uint16";
export const DataUint16Key: VDXFKeyInterface = {
...
export const DataInt32KeyName = "vrsc::data.type.int32";
export const DataInt32Key: VDXFKeyInterface = {
...
export const DataUint32KeyName = "vrsc::data.type.uint32";

export const DataUint32Key: VDXFKeyInterface = {
...
export const DataInt64KeyName = "vrsc::data.type.int64";

export const DataInt64Key: VDXFKeyInterface = {
...
export const DataUint64KeyName = "vrsc::data.type.uint64";

export const DataUint64Key: VDXFKeyInterface = {
...
export const DataUint160KeyName = "vrsc::data.type.uint160";

export const DataUint160Key: VDXFKeyInterface = {
...
export const DataUint256KeyName = "vrsc::data.type.uint256";

export const DataUint256Key: VDXFKeyInterface = {
...
export const DataStringKeyName = "vrsc::data.type.string";

export const DataStringKey: VDXFKeyInterface = {
...
export const DataVectorKeyName = "vrsc::data.type.vector";
export const DataVectorKey: VDXFKeyInterface = {
...
export const DataByteVectorKeyName = "vrsc::data.type.bytevector";

export const DataByteVectorKey: VDXFKeyInterface = {
...
export const DataInt32VectorKeyName = "vrsc::data.type.int32vector";

export const DataInt32VectorKey: VDXFKeyInterface = {
...
export const DataInt64VectorKeyName = "vrsc::data.type.int64vector";

export const DataInt64VectorKey: VDXFKeyInterface = {
...
export const DataCurrencyMapKeyName = "vrsc::data.type.object.currencymap";

export const DataCurrencyMapKey: VDXFKeyInterface = {
...
export const DataRatingsKeyName = "vrsc::data.type.object.ratings";

export const DataRatingsKey: VDXFKeyInterface = {
...
export const DataURLKeyName = "vrsc::data.type.object.url";

export const DataURLKey: VDXFKeyInterface = {
...
export const DataTransferDestinationKeyName = "vrsc::data.type.object.transferdestination";

export const DataTransferDestinationKey: VDXFKeyInterface = {
...
export const UTXORefKeyName = "vrsc::data.type.object.utxoref";

export const UTXORefKey: VDXFKeyInterface = {
...
export const CrossChainDataRefKeyName = "vrsc::data.type.object.crosschaindataref";

export const CrossChainDataRefKey: VDXFKeyInterface = {
...
export const EncryptionDescriptorKeyName = "vrsc::data.type.encryptiondescriptor";

export const EncryptionDescriptorKey: VDXFKeyInterface = {
...
export const SaltedDataKeyName = "vrsc::data.type.salteddata";

export const SaltedDataKey: VDXFKeyInterface = {
...
export const DataDescriptorKeyName = "vrsc::data.type.object.datadescriptor";

export const DataDescriptorKey: VDXFKeyInterface = {
...
export const SignatureDataKeyName = "vrsc::data.signaturedata";

export const SignatureDataKey: VDXFKeyInterface = {
...
export const VectorUint256KeyName = "vrsc::data.mmrhashes";

export const VectorUint256Key: VDXFKeyInterface = {
...
export const MMRLinksKeyName = "vrsc::data.mmrlinks";

export const MMRLinksKey: VDXFKeyInterface = {
...
export const MMRDescriptorKeyName = "vrsc::data.mmrdescriptor";

export const MMRDescriptorKey: VDXFKeyInterface = {
...
export const TypeDefinitionKeyName = "vrsc::data.type.typedefinition";

export const TypeDefinitionKey: VDXFKeyInterface = {
...
export const MultiMapKeyName = "vrsc::identity.multimapkey";

export const MultiMapKey: VDXFKeyInterface = {
...
export const ContentMultiMapRemoveKeyName = "vrsc::identity.multimapremove";

export const ContentMultiMapRemoveKey: VDXFKeyInterface = {
...
export const ProfileMediaKeyName = "vrsc::identity.profile.media";

export const ProfileMediaKey: VDXFKeyInterface = {
...
export const ZMemoMessageKeyName = "vrsc::system.zmemo.message";

export const ZMemoMessageKey: VDXFKeyInterface = {
...
export const ZMemoSignatureKeyName = "vrsc::system.zmemo.signature";

export const ZMemoSignatureKey: VDXFKeyInterface = {
...
export const CurrencyStartNotarizationKeyName = "vrsc::system.currency.startnotarization";

export const CurrencyStartNotarizationKey: VDXFKeyInterface = {
