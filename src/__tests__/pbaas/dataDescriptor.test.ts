...
describe('Serializes and deserializes dataDescriptors', () => {
    ...
    test('Datadescriptor with CrossChainDataRef', async () => {
        ...
        const crossChainVector = VdxfUniValue.vectorEncodeVDXFUni({[VDXF_Data.CrossChainDataRefKey.vdxfid]: crossChainRef.toJson()});
    ...
    test('Datadescriptor with SignatureData', async () => {
        ...
        const txDestVector = VdxfUniValue.vectorEncodeVDXFUni({[VDXF_Data.SignatureDataKey.vdxfid]: sigData.toJson()});
