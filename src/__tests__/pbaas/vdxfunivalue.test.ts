...
describe('Encodes and decodes VdxfUniValue', () => {
  ...
  test('deserialize crosschainproof data from vdxfuniValue', () => {
    const testrun = () => {
      ...
      expect(crossChainProofObject.chainObjects[0].vdxfd).toEqual(VDXF_Data.DataDescriptorKey.vdxfid)
      expect(crosschobj.chainObjects[0].vdxfd).toEqual(VDXF_Data.DataDescriptorKey.vdxfid)
