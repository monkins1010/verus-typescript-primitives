...
exports.DataDescriptorResponse = void 0;
...
class DataDescriptorResponse {
    constructor(data) {
        this.flags = data && data.flags ? data.flags : new bn_js_1.BN("0", 10);
        this.createdAt = data === null || data === void 0 ? void 0 : data.createdAt;
...
exports.DataDescriptorResponse = DataDescriptorResponse;
DataDescriptorResponse.RESPONSE_CONTAINS_REQUEST_ID = new bn_js_1.BN(2, 10);
