...
class AppEncryptionRequestDetails {
    ...
    hasSecondarySeedDerivation() {
        return this.flags.and(AppEncryptionRequestDetails.HAS_SECONDARY_SEED_DERIVATION_NUMBER).gt(new bn_js_1.BN(0));
    }
    hasFromAddress() {
        return this.flags.and(AppEncryptionRequestDetails.HAS_FROM_ADDRESS).gt(new bn_js_1.BN(0));
    }
    hasToAddress() {
        return this.flags.and(AppEncryptionRequestDetails.HAS_TO_ADDRESS).gt(new bn_js_1.BN(0));
    }
    getByteLength() {
        let length = 0;
